...
/**
 * Onboarding Step 4 — advance past plan selection to the go-live step.
 *
 ...
 * Either way the plan step is done, so advance the resume pointer to 5 and route
 * forward. onboarding_completed_at is NOT touched here (that is Step 5).
 */
