...
export function AnnouncementBar({
  ...
  return (
    <div className="relative bg-ink text-center text-[13px] font-medium text-surface">
      {/* px-5 / lg:px-6 to match every other diner surface — px-10 at every
          breakpoint meant 40px gutters on a 375px phone (UI audit P2-4). */}
      <p className="mx-auto max-w-[1440px] 2xl:max-w-[1680px] px-5 py-2 lg:px-6">{text}</p>
      <button
        type="button"
